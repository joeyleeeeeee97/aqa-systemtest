...
public class Client {
    ...
    public static void main(String[] args) throws Exception {
        ...
        URL request = new URL("https://localhost:12000/request/foo.html");
    ...
    private static SSLContext getSSLContext() throws Exception {
        String tlsType = System.getProperty("test.security.tls.type", "TLS");
        char[] passphrase = "passphrase".toCharArray();

        KeyStore ks = KeyStore.getInstance("JKS");
        ks.load(new FileInputStream( "/Users/joeylee.lz/alibaba/testkeys"), passphrase);
